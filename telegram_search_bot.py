...
• Проверяйте правильность написания
    ...
    async def handle_search_request(self, update: Update, context: ContextTypes.DEFAULT_TYPE, query_text=None):
...
Это может занять несколько минут.
        ...
        status_message = await update.message.reply_text(searching_message, parse_mode='Markdown')
...
🔗 [Перейти к товару]({result['link']})
                ...
                await status_message.edit_text(response_message, parse_mode='Markdown', disable_web_page_preview=True)
...
• Попробуйте синонимы
                ...
                await status_message.edit_text(no_results_message, parse_mode='Markdown')
...
Попробуйте еще раз или обратитесь к администратору.
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if user_id in self.user_states and self.user_states[user_id] == 'waiting_for_product':
        ...
        search_triggers = ['что ищем', 'ищем', 'найти', 'поиск', 'найди', 'поиск товара']
