    ...
    try:
        ...
        if response.headers.get('content-encoding') == 'br':
            ...
            try:
                ...
                print("Декомпрессированное содержимое сохранено в pitergsm_decompressed.html")
                
                # Проверяем, есть ли товары
                if "товар" in decompressed.decode('utf-8').lower() or "product" in decompressed.decode('utf-8').lower():
